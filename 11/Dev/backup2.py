...
class SymbolTable:
    ...
    def define(self, name, v_type, kind):
        if kind in [K.K_STATIC, K.K_FIELD]:
            ...
            index = len(self.subroutine_scope)
...
class CompilationEngine:
    def __init__(self, input_file, output_file):
        ...
        self.compileClass()
        print(self.symbolTable.class_scope)
        print(self.symbolTable.subroutine_scope)
        return
    ...
    def compileClass(self):
        ...
        self.getNextIdentifier("class declaration", True, K.K_NONE, "class")
    ...
    def compile(self):
        ...
        if is_dir:
            ...
            for globbed_filename in file_list:
                output_filename = globbed_filename[0:-5] + "Z.vm"
                CompilationEngine(globbed_filename, output_filename)
        else:
            output_filename = abs_path[0:-5] + "Z.vm"
